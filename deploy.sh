...
touch "$SECRETS_CACHE"
for key in JWT_SECRET OPENROUTER_API_KEY NVIDIA_API_KEY MANGO_API_KEY GROQ_API_KEY FREEMODEL_API_KEY AGNES_API_KEY ZEN_API_KEY ORCAROUTER_API_KEY ZHIPU_API_KEY TURNSTILE_SECRET RADAR_API_TOKEN VAPID_PRIVATE_KEY VAPID_PUBLIC_KEY PIXABAY_API_KEY; do
