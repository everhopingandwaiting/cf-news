...
INSERT OR IGNORE INTO news_sources (name, url, feed_url, category, language) VALUES
    ...
    ('Mayo Clinic News', 'https://newsnetwork.mayoclinic.org', 'https://newsnetwork.mayoclinic.org/tag/news-releases/feed/', 'health', 'en'),
    ...
    ('搜狐汽车', 'https://auto.sohu.com', 'https://auto.sohu.com/rss/qichexinwen.xml', 'auto', 'zh'),
    ('Motor1', 'https://www.motor1.com', 'https://www.motor1.com/rss/news/', 'auto', 'en'),
    ...
    ('WSJ Markets', 'https://www.wsj.com', 'https://feeds.wsjonline.com/wsj/xml/rss/3_7031.xml', 'stocks', 'en'),
    ...
    ('东方财富 策略研报', 'https://data.eastmoney.com/report/stock/strategy.html', 'https://rsshub.rssforever.com/eastmoney/report/strategyreport', 'funds', 'zh'),
