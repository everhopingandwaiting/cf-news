...
INSERT OR IGNORE INTO news_sources (name, url, feed_url, category, language) VALUES
    ...
    ('WebMD', 'https://www.webmd.com', 'https://rss.webmd.com/rss/rss.xml', 'health', 'en'),
    ...
    ('新浪汽车', 'https://auto.sina.com.cn', 'https://rss.sina.com.cn/auto/focus.xml', 'auto', 'zh'),
    ('Autoblog', 'https://www.autoblog.com', 'https://www.autoblog.com/rss.xml', 'auto', 'en'),
    ('新浪军事', 'https://mil.news.sina.com.cn', 'https://rss.sina.com.cn/mil/focus.xml', 'military', 'zh'),
    ...
    ('联合早报', 'https://www.zaobao.com.sg', 'https://feedx.site/rss/zaobao.xml', 'news', 'zh');
